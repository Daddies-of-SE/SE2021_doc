...
### 获取指定组织下所有活动GET `organizations/activities/{org_id}/`
...
### 获取指定用户发布的所有活动GET `users/released_activities/{user_id}/`
...
### 获取指定版块下的所有活动GET `blocks/activities/{block_id}/`
...
URL：http://127.0.0.1:8000/activities/participants/?user=7&act=3（参数在query params中，分别为用户id和活动id）
