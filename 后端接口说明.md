...
- [ ] 是否要区分个人活动和作为组织管理员发布的活动？

- [ ] 申请成为组织管理员

- [ ] 获取已关注组织或已关注板块发布的最新通知、新闻、活动的列表（接口2名称可以叫”获取关注对象的动态列表“）
...
### 上传组织头像 POST `orgAvatar/`

参考前端实现：https://www.pianshen.com/article/9247997847/

服务器保存图片路径/root/ReedSailing-Web/server_files/orgs/还没建
...
上传头像保存到`/root/ReedSailing-Web/server_files/orgs/org_id.jpg`
...
### 搜索所有组织 POST `organizations/search/`
...
URL：http://127.0.0.1:8000/organizations/search/
...
[
    {
        ...
        "name": "蓝天志愿者协会",
        "description": null,
        "create_time": "2021-05-11T14:00:36.811950",
        "avatar": null,
        "block": {
            "id": 2,
            "name": "志愿"
    ...
    },
    {
        ...
        "name": "志愿云",
        "description": null,
        "create_time": "2021-05-11T14:00:48.752979",
        "avatar": null,
        "block": {
            "id": 2,
            "name": "志愿"
...
### 搜索指定板块下组织 POST `blocks/organizations/search/2/{block_id}`
...
URL：http://127.0.0.1:8000/blocks/organizations/search/2/
...
### 搜索用户管理的组织 GET`users/managed_organizations/search/{id}/`
...
URL：http://127.0.0.1:8000/users/managed_organizations/search/2/
...
### 上传活动图片 POST `actAvatar/`

**服务器需要migrate**，保存图片文件路径/root/ReedSailing-Web/server_files/acts/还没有建

对应前端实现参考：https://www.pianshen.com/article/9247997847/
...
上传活动图片到`/root/ReedSailing-Web/server_files/acts/act_id.jpg`
...
URL：http://127.0.0.1:8000/activities/search/
...
[
    {
        ...
        "name": "急救知识讲座",
        "begin_time": "2021-10-22T11:00:00",
        "end_time": "2021-10-22T13:30:00",
        "pub_time": "2021-05-11T14:10:32.994223",
        "contain": 200,
        "description": null,
        "review": false,
        "type": {
    ...
    },
    {
        ...
        "name": "急救分享会",
        "begin_time": "2021-05-12T12:00:00",
        "end_time": "2021-05-12T13:00:00",
        "pub_time": "2021-05-11T14:11:22.642423",
        "contain": 20,
        "description": null,
        "review": false,
        "type": {
...
### 搜索指定组织下活动 POST `organizations/activities/search/{org_id}/`
...
URL：http://127.0.0.1:8000/organizations/activities/search/1/
...
### 搜索用户发布的活动 POST `users/released_activities/search/{user_id}/`
...
搜索对应id的用户发布的所有活动。（未区分个人活动和组织活动）

**Request**

URL：http://127.0.0.1:8000/users/released_activities/search/1/
...
### 搜索指定板块下活动 GET`blocks/activities/search/{block_id}`
...
URL：http://127.0.0.1:8000/blocks/activities/search/2/
...
### 搜索指定用户参与的活动 POST `user/joined_acts/search/{user_id}/`
...
URL：http://127.0.0.1:8000/user/joined_acts/search/1/
...
### 获取指定活动的所有报名人员 GET `activities/{act_id}/participants/`
...
URL：http://127.0.0.1:8000/activities/3/participants/
...
### 获取指定用户指定年月中参与的所有活动 GET `users/joined_acts/{id}/{year}/{month}/`
...
获取编号为id的用户在year年month月中参加的所有活动

**Request**

URL：http://127.0.0.1:8000/users/joined_acts/6/2021/5/
    ...
    "2021-05-16": [
        {
            "id": 10,
            "name": "1103",
            "begin_time": "2021-05-16T14:19:18",
            "end_time": "2021-05-17T14:19:18",
            "pub_time": "2021-05-06T11:04:05.783900",
            "contain": 10,
            "description": null,
            "review": false,
            "owner": 5,
    ...
    "2021-05-17": [
        {
            "id": 11,
            "name": "1104",
            "begin_time": "2021-05-17T14:19:18",
            "end_time": "2021-05-18T14:19:18",
            "pub_time": "2021-05-06T11:05:05.517019",
            "contain": 10,
            "description": null,
            "review": false,
            "owner": 5,
...
### 搜索评论 GET `activities/comments/search/`
...
URL： http://127.0.0.1:8000/activities/comments/search/
...
[
    {
        ...
        "content": "真的不错",
        "pub_time": "2021-05-21T13:52:00.632162",
        "score": 5
    }
]
```
...
### 搜索用户发布的评论 GET `activities/users/{user_id}/comments/search/`
...
URL：  http://127.0.0.1:8000/activities/users/1/comments/search/
...
### 搜索指定活动的评论 GET `activities/{act_id}/comments/search/`
...
URL：   http://127.0.0.1:8000/activities/1/comments/search/
...
URL： http://127.0.0.1:8000/feedbacks/search/
...
[
    {
        ...
        "content": "地图显示不全",
        "pub_time": "2021-05-21T15:10:48.040886"
    },
    {
        "id": 2,
        "user": {
        ...
        "content": "地图打不开啊",
        "pub_time": "2021-05-21T15:10:55.199736"
    }
]
```
...
### 搜索指定用户反馈 GET `feedbacks/user/<user_id>/search/`
...
URL：  http://127.0.0.1:8000/feedbacks/user/1/search/
