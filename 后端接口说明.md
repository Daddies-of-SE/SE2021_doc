...
URL：http://127.0.0.1:8000/categories/4/（表示修改id=4的活动分类的名称）
...
URL：http://127.0.0.1:8000/categories/4/（表示删除id=4的活动分类）
