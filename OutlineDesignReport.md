...
| 3    | 内部 | 用户登录          | 本文档                                                       | 验证登录信息，在数据库中保存该用户信息，取得登录凭证`token`  |
...
| ---- | ---- | ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 1    | 外部 | wx.login      | [wx.login](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/login/wx.login.html) | 调用接口获取登录凭证（code）。通过凭证进而换取用户登录态信息。 |
| 2    | 内部 | 用户登录      | 本文档                                                       | 验证登录信息，在数据库中保存该用户信息，取得登录凭证`token`  |
...
| 序号 | 类型 | 接口编号/名称    | 来源/文档编号 | 说明                                   |
| ---- | ---- | ---------------- | ------------- | -------------------------------------- |
| 1    | 内部 | 获取指定用户信息 | 本文档        | 获取编号为id的用户的信息               |
| 2    | 内部 | 修改指定用户信息 | 本文档        | 用于修改编号为id的用户的昵称，个人描述 |
...
| 序号 | 类型 | 接口编号/名称  | 来源/文档编号 | 说明                                                         |
| ---- | ---- | -------------- | ------------- | ------------------------------------------------------------ |
| 1    | 内部 | 发送验证码邮件 | 本文档        | 向指定邮箱发送验证码，缓存中保存邮箱和验证码配对信息         |
| 2    | 内部 | 验证码验证     | 本文档        | 验证用户输入的验证码是否和邮箱对应。如果成功验证，则在数据库中保存用户的邮箱（以后登录则不必认证） |
...
| 序号 | 类型 | 接口编号/名称 | 来源/文档编号 | 说明                                                   |
| ---- | ---- | ------------- | ------------- | ------------------------------------------------------ |
| 1    | 内部 | 创建组织申请  | 本文档        | 用户可以提交组织申请，用于向管理员申请创建一个新的组织 |
...
| 序号 | 类型 | 接口编号/名称      | 来源/文档编号 | 说明                             |
| ---- | ---- | ------------------ | ------------- | -------------------------------- |
| 1    | 内部 | 申请成为组织管理员 | 本文档        | 用户可以提交成为组织管理员的申请 |
...
| 序号 | 类型 | 接口编号/名称    | 来源/文档编号 | 说明                         |
| ---- | ---- | ---------------- | ------------- | ---------------------------- |
| 1    | 内部 | 用户取消关注组织 | 本文档        | 对应id用户取消关注对应id组织 |
...
| 序号 | 类型 | 接口编号/名称          | 来源/文档编号 | 说明                                                         |
| ---- | ---- | ---------------------- | ------------- | ------------------------------------------------------------ |
| 1    | 1    | 获取关注对象的动态列表 | 本文档        | 请求获取已关注组织或已关注板块发布的最新通知、新闻、活动列表 |
...
| 序号 | 类型 | 接口编号/名称            | 来源/文档编号 | 说明                           |
| ---- | ---- | ------------------------ | ------------- | ------------------------------ |
| 1    | 内部 | 获取指定组织的全部管理员 | 本文档        | 获取编号为id的组织的全部管理员 |
| 2    | 内部 | 组织负责人转让           | 本文档        | 将组织负责人转让给指定用户     |
...
| 序号 | 类型 | 接口编号/名称    | 来源/文档编号 | 说明                                 |
| ---- | ---- | ---------------- | ------------- | ------------------------------------ |
| 1    | 内部 | 获取指定用户信息 | 本文档        | 获取编号为id的用户的信息的名称、头像 |
| 2    | 内部 | 组织添加管理员   | 本文档        | 指定组织添加指定用户为管理员         |
...
| ---- | ---- | ------------------------ | ------------- | ------------------------------------ |
| 1    | 内部 | 获取指定组织的全部管理员 | 本文档        | 获取编号为id的组织的全部管理员       |
| 2    | 内部 | 取消组织管理员           | 本文档        | 取消对应用户的对应id组织的管理员身份 |
