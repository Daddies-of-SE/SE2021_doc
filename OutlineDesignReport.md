...
| 8    | 内部 | 获取所有版块                 | 后端接口说明  | 获取所有版块的id和名称                                       |
| 9    | 内部 | 新建版块                     | 后端接口说明  | 创建一个新的版块                                             |
| 10   | 内部 | 修改指定版块信息             | 后端接口说明  | 修改编号为id的版块                                           |
| 11   | 内部 | 删除指定版块                 | 后端接口说明  | 删除编号为id的版块                                           |
| 12   | 内部 | 创建组织申请                 | 后端接口说明  | 用户可以提交组织申请，用于向管理员申请创建一个新的组织       |
| 13   | 内部 | 获取指定用户的所有组织申请   | 后端接口说明  | 用于获取id=user_id的用户的所有组织申请                       |
| 14   | 内部 | 获取指定组织申请             | 后端接口说明  | 获取编号为id的组织申请的信息                                 |
| 15   | 内部 | 获取所有组织申请             | 后端接口说明  | 用于获取所有的组织申请                                       |
| 16   | 内部 | 删除指定组织申请             | 后端接口说明  | 删除编号为id的组织申请                                       |
| 17   | 内部 | 审批组织申请                 | 后端接口说明  | 审核指定id的组织申请                                         |
| 18   | 内部 | 新建组织                     | 后端接口说明  | 组织申请审批通过后创建组织                                   |
| 19   | 内部 | 获取指定组织信息             | 后端接口说明  | 获取编号为id的组织的信息                                     |
| 20   | 内部 | 获取指定版块下所有组织       | 后端接口说明  | 获取对应id的版块下的所有组织                                 |
| 21   | 内部 | 修改指定组织信息             | 后端接口说明  | 修改对应id的组织信息                                         |
| 22   | 内部 | 删除指定组织                 | 后端接口说明  | 删除编号为id的组织                                           |
| 23   | 内部 | 组织负责人转让               | 后端接口说明  | 将编号为id的组织的负责人更改为指定用户                       |
| 24   | 内部 | 用户关注组织                 | 后端接口说明  | 用户关注组织                                                 |
| 25   | 内部 | 用户取消关注组织             | 后端接口说明  | 对应id用户取消关注对应id组织                                 |
| 26   | 内部 | 获取指定用户关注的所有组织   | 后端接口说明  | 获取编号为id的用户的关注的所有组织                           |
| 27   | 内部 | 组织添加管理员               | 后端接口说明  | 指定组织添加指定用户为管理员                                 |
| 28   | 内部 | 取消组织管理员               | 后端接口说明  | 取消对应id用户的对应id组织的管理员身份                       |
| 29   | 内部 | 获取指定用户管理的所有组织   | 后端接口说明  | 获取编号为id的用户的管理的所有组织                           |
| 30   | 内部 | 获取指定组织的全部管理员     | 后端接口说明  | 获取编号为id的组织的全部管理员                               |
| 31   | 内部 | 获取所有活动分类             | 后端接口说明  | 获取所有分类的id和名称                                       |
| 32   | 内部 | 新建活动分类                 | 后端接口说明  | 创建一个新的活动分类                                         |
| 33   | 内部 | 修改指定活动分类信息         | 后端接口说明  | 修改编号为id的活动分类                                       |
| 34   | 内部 | 删除指定活动分类             | 后端接口说明  | 删除编号为id的活动分类                                       |
| 35   | 内部 | 获取所有活动地址             | 后端接口说明  | 获取所有活动地址的id、名称、经度、纬度                       |
| 36   | 内部 | 新建活动地址                 | 后端接口说明  | 创建一个新的活动地址                                         |
| 37   | 内部 | 删除指定活动地址             | 后端接口说明  | 删除编号为id的活动地址                                       |
| 38   | 内部 | 新建活动                     | 后端接口说明  | 新建一个活动                                                 |
| 39   | 内部 | 获取指定活动信息             | 后端接口说明  | 获取编号为id的活动的信息                                     |
| 40   | 内部 | 修改指定活动信息             | 后端接口说明  | 修改对应id的活动信息                                         |
| 41   | 内部 | 删除指定活动                 | 后端接口说明  | 删除编号为id的活动                                           |
| 42   | 内部 | 获取指定组织下所有活动       | 后端接口说明  | 获取对应id的组织下的所有活动                                 |
| 43   | 内部 | 获得指定组织未开始活动       | 后端接口说明  | 获取对应id的组织下的所有开始时间大于当前时间的活动           |
| 44   | 内部 | 获得指定组织进行中活动       | 后端接口说明  | 获取对应id的组织下的所有开始时间大于当前时间的活动           |
| 45   | 内部 | 获得指定组织已结束活动       | 后端接口说明  | 获取对应id的组织下的所有开始时间大于当前时间的活动           |
| 46   | 内部 | 获取指定用户发布的所有活动   | 后端接口说明  | 获取对应id的用户发布的所有活动                               |
| 47   | 内部 | 获取指定版块下的所有活动     | 后端接口说明  | 获取对应id的用户发布的所有活动                               |
| 48   | 内部 | 用户加入非审核活动           | 后端接口说明  | 用户加入一个无需审核的活动                                   |
| 49   | 内部 | 用户退出活动                 | 后端接口说明  | 对应id用户退出对应id的活动                                   |
| 50   | 内部 | 获取指定用户参与的所有活动   | 后端接口说明  | 获取编号为id的用户加入的所有活动                             |
| 51   | 内部 | 获取指定用户参与的未开始活动 | 后端接口说明  | 获取编号为id的用户加入的开始时间大于当前时间的活动           |
| 52   | 内部 | 获取指定用户参与的进行中活动 | 后端接口说明  | 获取编号为id的用户加入的开始时间小于等于当前时间的活动  且结束时间大于等于当前时间的活动 |
| 53   | 内部 | 获取指定用户参与的已结束活动 | 后端接口说明  | 获取编号为id的用户加入的结束时间小于当前时间的活动           |
| 54   | 内部 | 获取指定活动的报名人数       | 后端接口说明  | 获取编号为id的活动的报名人数                                 |
| 55   | 内部 | 获取所有用户反馈             | 后端接口说明  | 获取所有用户反馈                                             |
| 56   | 内部 | 新建用户反馈                 | 后端接口说明  | 创建一个新的用户反馈                                         |
| 57   | 内部 | 删除指定用户反馈             | 后端接口说明  | 删除编号为id的用户反馈                                       |
| 58   | 内部 | Super User注册               | 后端接口说明  | 超级管理员注册                                               |
| 59   | 内部 | SuperUser登录                | 后端接口说明  | 超级管理员登录                                               |
