...
| 0.3  | 李永毅，王肇凯，王佳瑞         | 2021.3.30 | 完成非功能性需求，功能性需求中更新活动、通知等部分 |
...
我们旨在改变这一现状，方便北航师生的课余生活。本项目由计算机学院软件工程课程组提出，*Daddies of SE*团队开发与部署，力图借助微信小程序，构建北航完整统一的活动发布、管理、社交平台。
...
点击进入“日程”界面，进入“活动地图”界面，查看已报名活动的位置。
...
点击进入“日程”界面，进入“活动日历”界面，查看已报名活动的时间（月视图）。
...
##### 3.3.1.19 查看参加的活动变更通知

###### 3.3.1.19.1 功能描述

对于已报名的活动，用户可接受活动变更信息。

###### 3.3.1.19.2 操作流程

用户收到小程序发送的活动变更提醒微信。在日程页面，活动变更时出现指定颜色提示气泡，页面变更提醒栏查看活动变更信息。
...
用户在报名参加的活动开始前收到活动开始提醒。

###### 3.3.1.20.2 操作流程

用户收到小程序发送的活动开始提醒微信。在日程页面，活动开始时出现指定颜色提示气泡，点击活动日历，开始的活动变为指定颜色。
...
##### 3.3.1.22 接受超级管理员修改通知

###### 3.3.1.22.1 功能描述

用户在自己所管理权限中，被超级管理员删除或修改，会收到提示信息。

###### 3.3.1.22.2 操作流程

在我的页面出现指定颜色提示气泡，在系统通知栏中出现数字提示信息，点击进入系统通知栏目，查看被系统修改通知。
