...
* 小程序端
  * 组织相关
    ...
    * 优先级低：组织发通知公告？
  * 优先级中：更新UI设计
  * 优先级高：时间格式化（例如改为”几小时前“、”昨天“）、组织名称最大字数（关注页面、推荐页面）、缺省提示（”您还没有关注任何组织哦“）
  * 优先级高：用户身份（不验证北航邮箱你就啥也别干）
  * 优先级高：**小程序内通知功能**、小程序外提醒
  * 活动&组织
    * 优先级中：活动/组织分享、导出为二维码、扫码跳转至活动/组织页面
    * 优先级高：搜索活动/组织功能
  ...
  * 活动相关
    ...
    * 优先级高：活动地址和分类设置
      * 地图选经纬度+起名字
    * 优先级低：活动报名审核、申请成为管理员：remove from 概要文档
  * 评论相关
    * 优先级高：点赞
    * 优先级高：按点赞数量排序
    * 优先级低：分页显示
