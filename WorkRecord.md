...
| 人员     | 工作                                  | 进展         |
| -------- | ------------------------------------- | ------------ |
| 乐洋     | 小程序/web；概要文档3                 | 完成概要文档 |
| 史鑫杰   | web；概要文档6                        |              |
| 开聚实   | 小程序/web；概要文档3                 | 进行中       |
| 王肇凯   | 小程序；概要文档45                    | 完成概要文档 |
| 王佳瑞   | 后端/web；周报、汇报ppt；概要文档1278 | 完成概要文档 |
| 李永毅   | 后端/web；概要文档1278                | 完成7        |
| 全体成员 | 概要文档                              |              |
...
* 提醒功能绑定到服务号消息
* 后端运行博雅脚本，自动更新博雅活动
* 各种报错检查等，例如组织名称不能为空，未登录，网络错误
* web端登录时后端返回token或sessionid
